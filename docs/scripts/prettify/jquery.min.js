...
(function (e, undefined) {
                        ...
                        for (t in e)
                            (n = s[t]),
                                ...
                                s !== r &&
                                    (l &&
                                    r &&
                                    (x.isPlainObject(r) || (i = x.isArray(r)))
                                        ? (i
                                              ? ((i = !1),
                                                (o =
                                                    n && x.isArray(n) ? n : []))
                    ...
                    if ((i = Q.exec(e)))
                        if ((s = i[1])) {
                            ...
                            if (
                                ...
                                return (
                                    H.apply(n, t.getElementsByClassName(s)), n
                                );
                        }
                    if (b.qsa && (!h || !h.test(e))) {
                        if (
                        ...
                        return t !== c && 9 === t.nodeType && t.documentElement
                            ? ((c = t),
                              ...
                              (r.find.TAG = b.getElementsByTagName
                                  ? function (e, t) {
                                        return typeof t.getElementsByTagName !==
                                            j
            ...
            function kt(e, t, n, i) {
                ...
                if (!i && 1 === f.length) {
                    if (
                        ...
                        if (
                            ((t = (r.find.ID(u.matches[0].replace(tt, nt), t) ||
                                [])[0]),
                            !t)
                        )
                            return n;
                ...
                if (e && 3 !== s && 8 !== s && 2 !== s)
                    return typeof e.getAttribute === r
                        ...
                        : ((1 === s && x.isXMLDoc(e)) ||
                              ...
                              (i =
                                  x.attrHooks[t] ||
                                  (x.expr.match.boolean.test(t) ? M : R))),
                          n === undefined
    ...
    (x.event = {
                ...
                while (l--)
                    if (
                        ...
                        s &&
                            !p.length &&
                            ((f.teardown &&
                                f.teardown.call(e, d, m.handle) !== !1) ||
        ...
        trigger: function (t, n, r, i) {
            ...
            if (
                ...
                3 !== r.nodeType &&
                    ...
                    (t = t[x.expando]
                        ? t
                        : new x.Event(d, "object" == typeof t && t)),
                    (t.isTrigger = i ? 2 : 3),
                    (t.namespace = g.join(".")),
                ...
                while ((i = s[t++]) && !e.isPropagationStopped()) {
                    ...
                    while (
                        ...
                        (!e.namespace_re || e.namespace_re.test(o.namespace)) &&
                            ...
                            (e.data = o.data),
                            (r = (
                                (x.event.special[o.origType] || {}).handle ||
                                o.handler
                            ).apply(i.elem, a)),
                            r !== undefined &&
                                (e.result = r) === !1 &&
        ...
        handlers: function (e, t) {
            ...
            return (
                t.length > a && s.push({ elem: this, handlers: t.slice(a) }), s
            );
        },
        ...
        function (e, t) {
            x.fn[e] = function (n, r) {
                ...
                return (
                    ...
                    this.length > 1 &&
                        (Q[e] || x.unique(i), "p" === e[0] && i.reverse()),
                    this.pushStack(i)
                );
            };
        }
    ...
    (lt.optgroup = lt.option),
        ...
        x.fn.extend({
            ...
            empty: function () {
                ...
                for (; null != (e = this[t]); t++)
                    1 === e.nodeType &&
                        (x.cleanData(gt(e, !1)), (e.textContent = ""));
                return this;
            },
            clone: function (e, t) {
                return (
            ...
            domManip: function (e, t, n) {
                ...
                if (
                    ...
                    for (
                        o = x.map(gt(r, "script"), ft), s = o.length;
                        c > l;
                        l++
                    )
                        (a = r),
    ...
    function dt(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            L.hasData(e) &&
                ((a = L.access(e)), (u = x.extend({}, a)), L.set(t, u));
        }
    }
    function gt(e, t) {
        ...
        return (
            n ||
                ...
                ("none" !== n && n) ||
                    ...
                    (t = (vt[0].contentWindow || vt[0].contentDocument)
                        .document),
        ...
        x(function () {
            x.support.reliableMarginRight ||
                (x.cssHooks.marginRight = {
                    get: function (e, t) {
                        return t
                            ? x.swap(e, { display: "inline-block" }, yt, [
                                  e,
                                  "marginRight",
                              ])
                            : undefined;
                ...
                x
                    ...
                    .done(function (e) {
                        (o = arguments),
                            s.html(
                                r
                                    ? x("<div>").append(x.parseHTML(e)).find(r)
                                    : e
                            );
                    })
                    .complete(
            ...
            ajax: function (e, t) {
                ...
                function k(e, t, o, a) {
                    ...
                    2 !== v &&
                        ...
                        (T.statusText = (t || C) + ""),
                        l
                            ? h.resolveWith(f, [m, C, T])
                            : h.rejectWith(f, [T, C, y]),
                        T.statusCode(g),
                        (g = undefined),
                        u &&
            ...
            return a || "jsonp" === t.dataTypes[0]
                ? ((i = t.jsonpCallback =
                  ...
                  r.always(function () {
                      (e[i] = o),
                          t[i] &&
                              ((t.jsonpCallback = n.jsonpCallback), pn.push(i)),
    ...
    (x.Tween = An),
        (An.prototype = {
            ...
            cur: function () {
                ...
                return e && e.get
                    ? e.get(this)
                    : An.propHooks._default.get(this);
            },
            run: function (e) {
                var t,
