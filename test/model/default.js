  ...
  describe('Default Model Statics', () => {
    ...
    describe('makeQuery', () => {
      it('versioning, filter - null', async () => {
        ...
        const item = await defaultModel.thisStatics.makeQuery.call(ctx, 'goSearch', null);
      ...
      it('!versioning, filter - OPT_OR', async () => {
        ...
        const item = await defaultModel.thisStatics.makeQuery.call(ctx, 'goSearch', filter);
        expect(item).to.be.deep.equal('result');
      });
    ...
    describe('getOne', () => {
      it('versioning, populate not specified', async () => {
        ...
        const item = await defaultModel.thisStatics.getOne.call(ctx, id);
      ...
      it('versioning, populate === null', async () => {
        ...
        const item = await defaultModel.thisStatics.getOne.call(ctx, id, null);
        expect(item._id).to.be.deep.equal(id);
        expect(item.loaded).to.be.true;
      });
    ...
    describe('getOneByID', () => {
      it('!increment', async () => {
        ...
        const item = await defaultModel.thisStatics.getOneByID.call(ctx, ID);
    ...
    describe('getOneRaw', () => {
      it('simple run', async () => {
        ...
        const item = await defaultModel.thisStatics.getOneRaw.call(ctx, id);
        expect(item).to.be.deep.equal({
          _id: id,
          loaded: true
        });
    ...
    describe('list', () => {
      it('list', async () => {
        ...
        const items = await defaultModel.thisStatics.list.call(ctx, skip, size, sorter, filter);
    ...
    describe('listByField', () => {
      it('!list, !filter, !populate', async () => {
        ...
        const items = await defaultModel.thisStatics.listByField.call(ctx, fieldName);
        expect(items).to.be.instanceof(Array);
      });
    });
    ...
    describe('listAndPopulate', () => {
      it('skip, size, sorter, filter, populate', async () => {
        ...
        const items = await defaultModel.thisStatics.listAndPopulate.call(ctx, skip, size, sorter, filter, populate);
        expect(items).to.be.instanceof(Array);
      });
    });
    ...
    describe('listAll', () => {
      it('versioning', async () => {
        ...
        const items = await defaultModel.thisStatics.listAll.call(ctx, skip, size, sorter, filter);
        expect(items).to.be.instanceof(Array);
      });
    ...
    describe('listAllAndPopulate', () => {
      it('versioning', async () => {
        ...
        const items = await defaultModel.thisStatics.listAllAndPopulate.call(ctx, ['fieldName']);
        expect(items).to.be.instanceof(Array);
      });
    });
    ...
    describe('listAndCount', () => {
      it('filter, !search, populate', async () => {
        ...
        const res = await defaultModel.thisStatics.listAndCount.call(ctx,
          skip, size, sorter, filter,
          search, populate
        );
    ...
    describe('countWithFilter', () => {
      it('countWithFilter', async () => {
        ...
        const itemsCount = await defaultModel.thisStatics.countWithFilter.call(ctx, filter);
    ...
    describe('update', () => {
      it('many', async () => {
        const items = await moduleProto.User.update({}, {default: true}, true);
        expect(items).to.exist;
        expect(items.length).to.be.equal(2);
        const statuses = items.map(item => item.status);
        expect(statuses.sort()).to.be.deep.equal(['fulfilled', 'rejected']);
      });
//--require mocha-suppress-logs
      it('one', async () => {
        const item2 = remember.load('item2');
        const item = await moduleProto.User.update({default: true}, {default: false});
        expect(item).to.exist;
