...
import * as mod_0 from '/var/server/nn/node_modules/not-test-module/controllers/user';
...
import * as mod_2 from '/var/server/nn/test/application/app/server/modules/post/controllers/user';
...
import * as mod_4 from '/var/server/nn/test/application/app/front/src/user/config';
appDefaultOptions = notFramework.notCommon.absorbModule(appDefaultOptions, mod_4);
import * as mod_5 from '/var/server/nn/test/application/app/front/src/user/joy';
