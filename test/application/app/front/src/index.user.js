...
import * as mod_1 from '/var/server/nn/test/application/app/server/modules/post/controllers/user';
...
import * as mod_3 from '/var/server/nn/test/application/app/front/src/user/config';
appDefaultOptions = notFramework.notCommon.absorbModule(appDefaultOptions, mod_3);

import * as mod_4 from '/var/server/nn/test/application/app/front/src/user/joy';
